...
public class TreeIterator<T> implements Iterator<T> {
	...
	/*
	 * the class variables keep track of how much the iterator has done so far,
	 * and what remains to be done. root is null when the iterator has not been
	 * initialized, or the entire tree has been visited. the first stack keeps
	 * track of the last node to return and all its ancestors the second stack
	 * keeps track of whether the node visited is to the left (false) or right
	 * (true) of its parent
	 */
	...
	/*
	 * find the leftmost node from this root, pushing all the intermediate nodes
	 * onto the visiting stack
	 * 
	 * @param node the root of the subtree for which we are trying to reach the
	 * leftmost node
	 * 
	...
	/*
	 * return the leftmost node that has not yet been visited that node is
	 * normally on top of the stack inorder traversal doesn't use the
	 * visitingRightChild stack
	 */
	...
	/*
	 * find the leftmost node from this root, pushing all the intermediate nodes
	 * onto the visiting stack and also stating that each is a left child of its
	 * parent
	 * 
	 * @param node the root of the subtree for which we are trying to reach the
	 * leftmost node
...
/**
 * BinaryNode is a node for binary tree.
 * 
 * @author PraveenK
 *
 * @param <T>
...
class BinaryNode<T> {
	...
	//Contains data to be stored in a node.
	T value;
	//References to the right and left child.
